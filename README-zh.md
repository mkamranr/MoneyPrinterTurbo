...
> [!NOTE]
> **本仓库是 [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) 的 Fork。**
>
> 原项目的全部功劳归 [harry0703](https://github.com/harry0703) 及上游
> [贡献者](https://github.com/harry0703/MoneyPrinterTurbo/graphs/contributors) 所有。本 Fork 跟随上游更新，
> 并新增了在自托管模型上运行文案生成与配音的能力（详见英文文档的
> [Local Models](README.md#local-models-) 一节）。许可协议与原项目相同，均为
> [MIT License](LICENSE)。
...
- [x] 支持 **多语言视频脚本** 生成
- [x] 支持 **Edge TTS**、**Azure Speech**、**SiliconFlow**、**Google Gemini**、**小米 MiMo**、**ElevenLabs**、**Chatterbox**、**Fish Audio**，以及任意**本地自托管的 OpenAI 兼容 TTS** 服务，均可实时试听
...
- [x] 支持 **Kimi / Moonshot AI**、**OpenAI**、**Anthropic Claude**、**Google Gemini**、**DeepSeek**、**阿里云通义千问**、**Microsoft Azure OpenAI**、**火山引擎方舟**、**xAI Grok**、**MiniMax**、**小米 MiMo** 等主流模型服务，并兼容 **Cloudflare AI Gateway**、**魔搭 ModelScope**、**AIHubMix**、**AIML API**、**EvoLink**、**vLLM**、**Ollama**、**OneAPI**、**LiteLLM**、**Groq**、**Pollinations AI** 等统一网关、聚合平台和本地运行环境
- [x] 支持 **完全本地运行**：搭配 [vLLM](https://docs.vllm.ai) 或 Ollama 生成文案、本地 OpenAI 兼容 TTS 服务生成配音，再配合本地素材，即可无需任何云端 API Key
...
默认使用免费的 **Edge TTS**，在 WebUI 中显示为 **Azure TTS V1**。项目同时支持 **Azure TTS V2**、**SiliconFlow TTS**、**Google Gemini TTS**、**小米 MiMo TTS**、**ElevenLabs TTS**、自托管 **Chatterbox TTS**、**Fish Audio TTS**、**Local TTS (OpenAI-compatible)**（对接任意自托管服务），以及无配音模式。
